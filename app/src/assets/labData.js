...
// Real reading-comprehension passages + questions, sourced from the RACE
// dataset (Lai et al., 2017, "RACE: Large-scale ReAding Comprehension Dataset
// From Examinations", https://www.cs.cmu.edu/~glai1/data/race/), used here under
// its non-commercial-research license — this app has no payments, ads,
// subscriptions, or any other commercial activity. Each passage below is one
// item from RACE's "high" (high-school-level) split; the RACE example_id is
// kept in each passage's id for traceability back to the source dataset. A
// large pool (40 passages) is kept here on purpose: each run draws from it at
// random without repeats, so a big pool keeps different participants' sessions
// from overlapping much, if at all. Beyond the punctuation/spacing cleanup
// noted before, a handful of missing-space word glue bugs ("aliquid" ->
// "a liquid", "offriends" -> "of friends"), two leftover Word/XML markup
// fragments ("prefix = st1 /"), and a couple of clear name typos ("Immauel
// Kant" -> "Immanuel Kant", "Joannic Rochette" -> "Joannie Rochette") were
// also fixed on import.
const passages = [
    new Passage({
        id: "race-high20171",
        ...
        questions: [
            {
                ...
                options: { A: "We can find water when it turns into vapour.", B: "Water is only in seas and rivers.", C: "We can see water in deserts here and there.", D: "Water can be found almost everywhere." },
                correctIndex: 3
            },
            {
                number: 2,
                question: "We can drink water when it is _",
                options: { A: "a solid", B: "a liquid", C: "in the air", D: "turned into ice" },
                correctIndex: 1
            },
            {
                number: 3,
        ...
        questions: [
            {
                ...
                options: { A: "You should never eat delicious foods.", B: "Drinking some water or soup before eating helps you to eat less.", C: "Holidays are happy days but they may bring you weight problems.", D: "Physical exercise can reduce the chance of putting on weight." },
                correctIndex: 0
            },
            {
                number: 2,
                question: "Which of the following can NOT help people to lose weight according to the passage?",
                options: { A: "Eating lean meat.", B: "Creamy food.", C: "Eating raw fruit or vegetables.", D: "Physical exercise." },
                correctIndex: 1
            },
            {
                number: 3,
            ...
            },
            {
                ...
                options: { A: "Holidays and Festivals section", B: "Health and Fitness section", C: "Fashion section", D: "Student Times Club section" },
                correctIndex: 1
            },
            {
                number: 5,
                question: "What is the best title of the passage?",
                options: { A: "How to avoid holiday feasting.", B: "Do's and don'ts for keeping slim and fit.", C: "How to avoid weight gain over holidays.", D: "Wonderful holidays, boring experiences." },
                correctIndex: 2
            },
        ]
    }),
        ...
        questions: [
            {
                ...
                options: { A: "She didn't want to get into an argument.", B: "She was full of pity for the man.", C: "The man was dangerous and brave.", D: "She was too careless to notice it." },
                correctIndex: 0
            },
            {
                number: 2,
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "Butterflies are quite rare in Britain.", B: "Butterflies like travelling frequently.", C: "A rare butterfly appeared in Britain.", D: "The butterfly world changed a lot." },
                correctIndex: 2
            },
        ]
    }),
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "He could prepare meals in a small kitchen.", B: "He was famous for his shows on Food TV.", C: "He was good at using eggs to make sandwiches.", D: "He could cook cheap, delicious and simple meals." },
                correctIndex: 3
            },
            {
                number: 5,
                question: "What can we learn about Lieberman from the text?",
                options: { A: "He is clever but lonely.", B: "He is friendly and active.", C: "He enjoys traveling around.", D: "He often changes his menus." },
                correctIndex: 1
            },
        ]
    }),
    new Passage({
        ...
        questions: [
            ...
            {
                number: 2,
                question: "What's the purpose of students sitting one independent exam to gain entrance to the seven universities?",
                options: { A: "It can reduce students' load to take several exams.", B: "The universities will have the same standard to test students.", C: "There will be less trouble marking students' test papers.", D: "It can avoid fierce competition among these universities." },
                correctIndex: 0
            },
            {
                number: 3,
            ...
            {
                number: 4,
                question: "What is the advantage of universities selecting students according to independent examinations?",
                options: { A: "Students needn't take the national exam.", B: "Students' education cost can be lowered.", C: "Students' abilities and talents can be better found.", D: "It can encourage middle schools to recommend more qualified students." },
                correctIndex: 2
            },
        ]
    }),
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "Kant is satisfied with the trend of tourism", B: "Kant worries about the future of India's tourism", C: "Choudhury doesn't think the situations of tourism will improve", D: "Choudhury thinks India should make full preparations for the crisis of tourists" },
                correctIndex: 0
            },
            {
                number: 3,
                question: "Which of the following may NOT belong to the advantages of India?",
                options: { A: "Hospitality.", B: "Cultural diversity.", C: "Good value for money.", D: "Natural scenery." },
                correctIndex: 3
            },
            {
                number: 4,
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "Cigarette vending machines banned", B: "The youth's addiction to tobacco", C: "UK's efforts to improve people's health", D: "Strong opposition from tobacco industry" },
                correctIndex: 0
            },
        ]
    }),
    new Passage({
        ...
        questions: [
            {
                number: 1,
                question: "What has become a concern about plastic?",
                options: { A: "Using it properly.", B: "Producing it cheaply.", C: "Developing its properties quickly.", D: "Evaluating its contributions fairly." },
                correctIndex: 0
            },
            {
                number: 2,
            ...
            {
                number: 3,
                question: "What are the inventors doing in the lab?",
                options: { A: "Replacing carbon fibers with shrilk.", B: "Testing Shrilk's use in wet conditions.", C: "Making shrilk out of used household goods.", D: "Improving shrilk's flexibility for medical purposes." },
                correctIndex: 1
            },
            {
                number: 4,
                question: "Which of the following can be the best title for the passage?",
                options: { A: "Recent Progress in Environmental Protection", B: "Benefits of Insects in Scientific Research", C: "The Harm of One-time Products", D: "A Possible Alternative to Plastic" },
                correctIndex: 3
            },
        ]
    }),
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "3D technologies", B: "indoor rides", C: "G-forces", D: "dynamic structures" },
                correctIndex: 0
            },
            {
                number: 3,
                question: "What is the best title for the passage?",
                options: { A: "The Fastest Roller Coaster", B: "The Smiler and G-forces", C: "Screaming for Fun", D: "The New Technology" },
                correctIndex: 2
            },
        ]
    }),
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "Gender and age.", B: "Culture and environment.", C: "Study and work experience.", D: "Family background." },
                correctIndex: 1
            },
            {
                number: 3,
                question: "What's the importance of having more women engaged in STEM subjects?",
                options: { A: "Women can help men in science and engineering work.", B: "Women are wiser and more cooperative than men.", C: "Women play a more important part in scientific research.", D: "Having both women and men in science and engineering can produce better scientific achievement." },
                correctIndex: 3
            },
        ]
    }),
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "A Hard-working Trick Driver", B: "Medicine", C: "A Strange Illness", D: "Twelve Hours" },
                correctIndex: 3
            },
        ]
    }),
        ...
        questions: [
            {
                ...
                options: { A: "Different families have different ways of life.", B: "Different definitions could be given to the word.", C: "Different nations have different families.", D: "Different times produce different families." },
                correctIndex: 1
            },
            {
                number: 2,
            ...
            },
            {
                ...
                options: { A: "It is the best book on marriage.", B: "It is a handbook of marriage.", C: "It gives quite some idea of English social life in the past.", D: "It provides a lot of information of former time wealthy families." },
                correctIndex: 2
            },
            {
                number: 5,
        ...
        questions: [
            {
                ...
                options: { A: "Because there were no national parks in Canada then.", B: "Because hot mineral springs were found in Banff.", C: "Because there were many valleys and mountains.", D: "Because there were lots of scenic islands." },
                correctIndex: 1
            },
            {
                number: 2,
            ...
            },
            {
                ...
                options: { A: "Wood Buffalo National Park is famous as one of the largest national parks in the world.", B: "Banff National Park established because of the discovery of hot mineral springs.", C: "St. Lawrence Islands' establishment marked the beginning of Canada's national park system.", D: "Grasslands National Park preserves a part of the mixed prairie grasslands." },
                correctIndex: 2
            },
            {
                number: 4,
                question: "This passage is mainly taken from _.",
                options: { A: "a travel guidebook", B: "a student's textbook", C: "the latest newspaper", D: "an entertaining book" },
                correctIndex: 0
            },
        ]
    }),
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "The stories of some hypertension patients.", B: "Medical treatments of blood pressure.", C: "Storytelling may help lower blood pressure.", D: "Suggestions about how to lower blood pressure." },
                correctIndex: 1
            },
        ]
    }),
        ...
        questions: [
            {
                ...
                options: { A: "For shrinking, people can do nothing about it.", B: "If someone is injured, he will become shorter.", C: "Women have smaller and lighter bones than men.", D: "We aren't as tall at the end of the day as we are at the beginning." },
                correctIndex: 3
            },
            {
                number: 2,
                question: "What should we do if we don't want to shrink faster?",
                options: { A: "We should try to reduce gravity.", B: "We should be careful not to be hurt by others.", C: "We should sleep as long as possible.", D: "We should keep away from smoking and drinking alcohol." },
                correctIndex: 3
            },
            {
                number: 3,
                question: "What is the topic of the passage?",
                options: { A: "How can we stop shrinking?", B: "Why do we shrink?", C: "Some tips on how to keep tall.", D: "How to live a healthy life." },
                correctIndex: 1
            },
            {
                number: 4,
    ...
    new Passage({
        ...
        questions: [
            {
                number: 1,
                question: "Both experiments show that_.",
                options: { A: "Rico is smart enough to get all commands right", B: "Rico can recognize different things including toys", C: "Rico has developed the ability of learning mathematics", D: "Rico won't forget the names of objects once recognizing them" },
                correctIndex: 1
            },
            {
                number: 2,
                question: "Which of the following statements is true?",
                options: { A: "The purpose of the experiments is to show the border collie's mental abilities.", B: "Rico has a better memory partly because of its proper early training.", C: "The border collie is world-famous for recognizing objects.", D: "Rico is born to understand its owner's commands." },
                correctIndex: 1
            },
            {
                number: 3,
                question: "What does the writer want to tell us?",
                options: { A: "To train your dog.", B: "To talk with your dog.", C: "To be friendly to your dog.", D: "To be careful with your dog." },
                correctIndex: 2
            },
        ]
    }),
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "Philosophy is an independent discipline.", B: "Logic helps you to become a better thinker.", C: "The study of philosophy brings you immediate benefits.", D: "The meaning of philosophy is too limited to define." },
                correctIndex: 1
            },
            {
                number: 3,
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "His family are eager to collect the books written by Frank.", B: "His main job is to deliver mails and postcards for Frank.", C: "He has been a postman who has a great many secrets.", D: "He has developed a good relationship with Frank." },
                correctIndex: 3
            },
            {
                number: 3,
                question: "What was Mr. Warren's secret according to the passage?",
                options: { A: "He once took the lift only for one floor.", B: "He is interested in collecting others' secrets.", C: "He created an art project without telling his wife.", D: "He helped prevent others from committing suicides." },
                correctIndex: 2
            },
        ]
    }),
        ...
        questions: [
            {
                ...
                options: { A: "The old furniture is still in the author's fist bedroom.", B: "The author can still visit her first physical home in Los Angeles.", C: "The author's favorite room in her first home is the dining room.", D: "Many people of the author's age can still find their first physical homes." },
                correctIndex: 1
            },
            {
                number: 2,
            ...
            },
            {
                ...
                options: { A: "To express how much she is attached to her home.", B: "To declare how much she loves her first house.", C: "To describe the state of her family.", D: "To look back on her childhood." },
                correctIndex: 0
            },
        ]
    }),
        ...
        questions: [
            {
                ...
                options: { A: "His IQ reached between 220 and 230.", B: "At the age of 16, he graduated from a grammar school.", C: "At the age of 6, he graduated with both Master's and Bachelor's degrees.", D: "At the age of 11, he became the youngest student at the Harvard University." },
                correctIndex: 3
            },
            {
                number: 2,
            ...
            },
            {
                ...
                options: { A: "William", B: "Terence Tao", C: "Christopher Hirata", D: "Albert Einstein" },
                correctIndex: 2
            },
            {
                number: 4,
        ...
        questions: [
            {
                ...
                options: { A: "Tiger Woods'life in playing golf.", B: "The achievements of two golf players from ethnic minorities.", C: "Michelle Wie's determination.", D: "Playing golf in the USA was once the hobby of old, middle class white men." },
                correctIndex: 1
            },
            {
                number: 2,
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "her mother would not give her approval", B: "she would fail to get credits in Israel", C: "a well-paid summer job would be lost", D: "$1 600 couldn't be drawn out in time" },
                correctIndex: 2
            },
            {
                number: 4,
    ...
    new Passage({
        ...
        questions: [
            ...
            {
                number: 4,
                question: "What did the writer think of her friend's new decision?",
                options: { A: "She found it funny and wrong.", B: "She found it unacceptable and unbelievable.", C: "She found it surprising and meaningful.", D: "She found it difficult and meaningless." },
                correctIndex: 2
            },
        ]
    }),
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "Culture.", B: "Society.", C: "Campus Life.", D: "Lifestyle." },
                correctIndex: 2
            },
        ]
    }),
    ...
    new Passage({
        ...
        questions: [
            ...
            },
            {
                ...
                options: { A: "Humans and rats differ in their preference for risk-taking.", B: "Too much risk-taking can do more harm than good.", C: "Risk-taking can be used to treat people with impulse control problems.", D: "Risk-taking is a means of survival and brings higher returns to humans." },
                correctIndex: 3
            },
        ]
    }),
    new Passage({
        ...
        questions: [
            ...
            {
                number: 2,
                question: "According to the passage, which of the following is one of the reasons why the disease is called \"Swine flu\"?",
                options: { A: "Some patients have eaten some not-so-well-cooked pork.", B: "Some patients have contact with pigs in their life.", C: "The virus is probably developed from swine flu virus.", D: "The disease is mostly passed from pigs to humans." },
                correctIndex: 2
            },
            {
                number: 3,
                question: "Suppose Mr Fernando has just been back from Mexico and he's got a high fever and runny nose, what shall he do?",
                options: { A: "Go to hospital as soon as possible.", B: "Ask a day off and stay at home.", C: "Call his doctor to ask for directions.", D: "Take some medicine and have a good rest." },
                correctIndex: 2
            },
            {
                number: 4,
                question: "Which of the following is NOT a suggestion given by the writer?",
                options: { A: "Cough and sneeze into your hands.", B: "Wash your hands and wear a mask.", C: "Go on eating pork if you like.", D: "Store some food and medicine at home." },
                correctIndex: 0
            },
        ]
    }),
