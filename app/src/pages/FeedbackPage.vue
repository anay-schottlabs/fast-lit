...
<template>
    ...
    <div class="hero mt-30 max-w-3xl mx-auto px-4">  
        <div class="hero-content flex flex-col items-center gap-6">
            ...
            <div class="flex flex-col items-center text-center">
                <h1 class="text-7xl font-bold">{{ FeedbackScripts.heroTitle }}</h1>
                <p class="py-6">{{ FeedbackScripts.heroContent }}</p>
                <button
                    class="btn-red btn-wide mt-2"
                    @click="openForm"
                >
